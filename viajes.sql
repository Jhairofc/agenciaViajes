...
INSERT INTO `testimoniales` VALUES (1,'Jhairo','jhairo@gmail.com','Unas muy buenas vacaciones'),(2,'Nicolas','nicolas@live.com','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s'),(3,'Angie','angie@live.com','It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', '),(4,'Nataly','viaje@correo.com','El mejor viaje de mi vida'),(8,'Async','async@correo.com','Mensaje utilizando Async / Await');
...
-- Dump completed on 2020-06-06 11:13:15
